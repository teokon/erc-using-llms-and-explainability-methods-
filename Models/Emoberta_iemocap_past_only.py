#!/usr/bin/env python3
"""
IEMOCAP (6-way) / RoBERTa-large — PAST-ONLY context ablation.
...
Run (inside tmux, single idle/assigned GPU set below):
    cd Models
    python Emoberta_iemocap_past_only.py \
        2>&1 | tee checkpoints/emoberta_iemocap_large_past_only_run.log
"""
...
OUTPUT_DIR = CHECKPOINTS_DIR / "emoberta_iemocap_large_past_only"
