#!/usr/bin/env python3
"""
IEMOCAP (6-way) / RoBERTa-large — FUTURE-ONLY context ablation.
...
EmoBERTa-faithful rebuild from RAW IEMOCAP CSVs:
  ...
  - context builder shared via iemocap_context.py (mode="future")

Run (inside tmux, single idle/assigned GPU set below):
    cd Models
    python Emoberta_iemocap_future_only.py \
        2>&1 | tee checkpoints/emoberta_iemocap_large_future_only_run.log
"""
...
# =====================
# CONFIG (IEMOCAP 6-way, FUTURE-ONLY context)
# =====================
CONTEXT_MODE = "future"
...
OUTPUT_DIR = CHECKPOINTS_DIR / "emoberta_iemocap_large_future_only"
...
# =====================
# Build datasets from raw IEMOCAP (mode="future")
# =====================
